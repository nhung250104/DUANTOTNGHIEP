  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        partnerCode:        `${String(me.code || me.id).padStart(6, "0")}`,
        partnerName:        me.name,
        currentParentId:    currentParent ? String(currentParent.id) : null,
        currentParentName:  currentParent?.name || null,
        currentParentCode:  currentParent ? `${String(currentParent.code || currentParent.id).padStart(6, "0")}` : null,
        newParentId:        String(foundParent.id),
        newParentName:      foundParent.name,
        newParentCode:      `${String(foundParent.code || foundParent.id).padStart(6, "0")}`,
        reason:             reason.trim(),
        status:             "pending",
        createdAt:          getNow(),
        processedAt:        null,
        ...
        <div className="cc-modal-body">
          ...
          <div style={{
            ...
            {currentParent
              ...
              : "Chưa có cấp trên (đang là ROOT — Cấp 0)"}
          </div>
